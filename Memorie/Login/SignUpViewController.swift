...
class SignUpViewController: UIViewController {
    ...
    @IBAction func ExistingCodeTapped(_ sender: Any) {
        ...
        self.sentTo = self.username.text
    ...
    @IBAction func signUp(_ sender: AnyObject) {
        ...
        guard let userNameValue = self.username.text, !userNameValue.isEmpty,
            ...
            let confirmPasswordValue = self.confirmPassword.text, !confirmPasswordValue.isEmpty,
            password.text == confirmPassword.text else
        {
        ...
        if let emailValue = self.username.text, !emailValue.isEmpty {
